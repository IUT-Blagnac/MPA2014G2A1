...
public class Projet {
	...
	//Constructeurs
	/**Constructeur complet du projet. <b> Attention ! L'ordre des deux derniers paramètres intervenants sont importants : le premier est superviseur, le deuxième support technique. 
