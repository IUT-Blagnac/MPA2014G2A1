...
public class Groupe {
	...
	/**Accesseur de tous les voeux en position passée en paramétre
	 * @param pos
	...
	/** Fonction retournant les groupes ayant le sujet passé en paramétre dans leur liste de voeux à la position donnée en paramétre
